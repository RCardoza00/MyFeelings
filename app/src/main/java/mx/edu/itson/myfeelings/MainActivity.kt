package mx.edu.itson.myfeelings

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.util.Log
import android.widget.Toast
import mx.edu.itson.myfeelings.R
import mx.edu.itson.myfeelings.utilities.CustomBarDrawable
import mx.edu.itson.myfeelings.utilities.CustomCircleDrawable
import mx.edu.itson.myfeelings.utilities.Emociones
import mx.edu.itson.myfeelings.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        veryHappysButton.setOnClickListener {
            veryHappy++
            iconoMayoria()
            actualizarGrafica()
        }
        ...
        neutraladButton.setOnClickListener {
            neutral++
            iconoMayoria()
            actualizarGrafica()
        }
